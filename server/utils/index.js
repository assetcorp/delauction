...
export const buildResponse = ( message = 'Not found' ) => {
  return {
    message,
  }
}
...
export const buildErrorResponse = ( message = genericErrorMessage ) => {
  return buildResponse( message )
}

export const setDefaultResponse = ( res, code = 405, message = 'We cannot process this request' ) => {
  res.status( code ).json( buildErrorResponse( message ) )
}
...
export const signJwt = ( payload, expiry = '1w' ) => {
  return {
